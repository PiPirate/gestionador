        ...
        <x-modules.card>
            ...
            @forelse ($investors as $investor)
                <div class="grid grid-cols-6 py-3 text-sm items-center">
                    ...
                    <span
                        class="text-right font-semibold text-gray-900">{{ \App\Support\Currency::format($investor->totalInvestedCop(), 'cop') }}</span>
                    <span
                        class="text-right font-semibold text-gray-900">{{ \App\Support\Currency::format($investor->totalGainsCop(), 'cop') }}</span>
